...
from layers.MLPs import series_decomp, RevIN, MLPfreq
...
class Model(nn.Module):
    ...
    def forward(self, x_enc ,batch_x_mark):
        ...
        seasonal_part = self.decoder(seasonal_init, batch_x_mark)  # dlinear for seasonal
